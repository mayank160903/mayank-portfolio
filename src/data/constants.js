...
export const projects = [
  {
    ...
    description:
      "A Next.js Based Web Application where a user can upload prompts that are commonly used for getting different requests from Chat GPT. It involves all CRUD Operations, as well as OAuth 2.0 for authentication.",
    image:
      promptapp,
    tags: [
      "Next Js",
  ...
  },
  {
    ...
    description:
      "A MERN Stack Blogging Application where a user can upload Blogs of different places along with pictures and location fetched from the Google Maps API and the Google Geocoding API.",
    image:
